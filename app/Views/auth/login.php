...
<form method="post" action="<?= site_url('login') ?>" class="stack-md">
    ...
    <div class="field field-required">
        ...
        <input id="identifier" name="identifier" autocomplete="username" placeholder="e.g. admin@local.test" value="<?= esc((string) old('identifier')) ?>" required aria-required="true" autofocus>
    </div>
