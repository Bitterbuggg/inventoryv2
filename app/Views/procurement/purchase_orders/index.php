...
<style>
    ...
    th.sortable { 
        cursor: pointer; 
        position: relative; 
        padding-right: 28px !important; /* Protects the right edge */
        user-select: none; 
    ...
    <section class="card stack-md">
        ...
        <div class="table-wrap">
            <table class="table" id="po-table" style="table-layout: fixed; width: 100%; min-width: 1050px;">
                <colgroup>
                    <col style="width: 60px;">  <col style="width: 150px;"> <col style="width: 80px;">  <col style="width: 25%;">   <col style="width: 120px;"> <col style="width: 180px;"> <col style="width: 120px;"> <col style="width: 180px;"> </colgroup>
                <thead>
                    <tr>
                        ...
                        <th class="sortable" data-col="5" id="status-header" title="Click to cycle status filters!" style="line-height: 1.2;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 16px; margin-top: 8px; border-top: 1px solid var(--color-border);">
            <p class="muted" style="margin: 0; font-size: 0.85rem; line-height: 1;">
                Showing records <span id="page-indicator"></span> (Total: <span id="total-indicator"><?= esc((string) $totalOrders) ?></span>)
            </p>
            ...
            document.querySelectorAll('#po-table th.sortable').forEach(th => {
                ...
                th.addEventListener('click', () => {
                    ...
                    currentRows.sort((a, b) => {
                        // Strip out commmas, PR-, and # for clean numeric sorting
